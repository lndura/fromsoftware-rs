...
/// This is used in the [Map<>] lookups for [CSPad] and [KeyAssign] instances as the Key.
...
type CSPadEntryMapList =
    DLFixedVector<NonNull<Map<RuntimeTypeHandle, PadEntry, &'static DLAllocator>>, CAPACITY>;

/// DLFixedVector with 4 pointers to `Map<>` instances that hold a [CSKeyAssign].
type CSKeyAssignMapList = DLFixedVector<
    NonNull<Map<RuntimeTypeHandle, NonNull<CSKeyAssign>, &'static DLAllocator>>,
    CAPACITY,
>;
